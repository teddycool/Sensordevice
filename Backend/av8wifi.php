...
FROM measurement 
WHERE DeviceName IN  ('av8_k1', 'av8_s1') AND  Measurement IN ( 'wifi')  AND Time BETWEEN DATE_SUB( NOW() , INTERVAL 1 DAY ) AND NOW()
...
$jsondata = $jsondata . '{"label": "WiFi försök kökssensor", "type": "number"},';
$jsondata = $jsondata . '{"label": "WiFi försök utesensor", "type": "number"}';
$jsondata = $jsondata . '],';
